...
.. cfgcmd:: interfaces bonding <interface> address <address | dhcp | dhcpv6>
...
.. cfgcmd:: interfaces bonding <interface> ipv6 address autoconf

   .. include:: ../../_include/interface-ipv6-addr-autoconf.txt

.. cfgcmd:: interfaces bonding <interface> ipv6 address eui64 <prefix>
...
.. cfgcmd:: interfaces bonding <interface> description <description>

   Assign given `<description>` to interface. Description will also be passed
   to SNMP monitoring systems.


.. cfgcmd:: interfaces bonding <interface> disable

   Disable given `<interface>`. It will be placed in administratively down
   (``A/D``) state.

.. cfgcmd:: interfaces bonding <interface> mac <mac-address>

   Configure user defined :abbr:`MAC (Media Access Control)` address on given
   `<interface>`.

.. cfgcmd:: interfaces bonding <interface> mode <mode>
...
.. cfgcmd:: interfaces bonding <interface> hash-policy <policy>
...
.. cfgcmd:: interfaces bonding <interface> primary <interface>
...
.. cfgcmd:: interfaces bonding <interface> arp-monitor interval <time>
...
.. cfgcmd:: interfaces bonding <interface> arp-monitor target <address>
...
.. cfgcmd:: interfaces bonding <interface> member interface <member>
...
.. opcmd:: show interfaces bonding
   ...
   Show summary information about bonding interfaces.
